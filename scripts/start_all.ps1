# One-click start: mineru-api :8001 + adapter :8003 + API :8002 + frontend :5173
# Uses project-root venv (Python 3.12 + mineru[pipeline])
#
# Usage:
#   powershell -ExecutionPolicy Bypass -File scripts\start_all.ps1
#   powershell -ExecutionPolicy Bypass -File scripts\start_all.ps1 -SkipFrontend
#   powershell -ExecutionPolicy Bypass -File scripts\start_all.ps1 -Restart
#   powershell -ExecutionPolicy Bypass -File scripts\start_all.ps1 -OpenBrowser
...
Write-Host " regulations_doc_platform  start-all" -ForegroundColor Cyan
